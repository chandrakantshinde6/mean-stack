...
<title>end to end lab: globby</title>
...
<div><div class="header">
  <div class="headertitle"><div class="title">globby </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><blockquote class="doxtable">
<p >&zwj;User-friendly glob matching </p>
</blockquote>
<p>Based on <a href="https://github.com/mrmlnc/fast-glob"><code>fast-glob</code></a> but adds a bunch of useful features.</p>
<h1><a class="anchor" id="autotoc_md5897"></a>
Features</h1>
<ul>
<li>Promise API</li>
<li>Multiple patterns</li>
<li>Negated patterns: &lsquo;['foo*&rsquo;, '!foobar']<code></code></li>
<li><code>Expands directories:</code>foo<code>→</code>foo/**/*<code></code></li>
<li><code>Supports</code>.gitignore<code></code></li>
<li><code>Supports</code>URL<code>as</code>cwd`</li>
</ul>
<h1><a class="anchor" id="autotoc_md5898"></a>
Install</h1>
<div class="fragment"><div class="line">$ npm install globby</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md5899"></a>
Usage</h1>
<div class="fragment"><div class="line">├── unicorn</div>
<div class="line">├── cake</div>
<div class="line">└── rainbow</div>
</div><!-- fragment --><div class="fragment"><div class="line">import {globby} from &#39;globby&#39;;</div>
<div class="line"> </div>
<div class="line">const paths = await globby([&#39;*&#39;, &#39;!cake&#39;]);</div>
<div class="line"> </div>
<div class="line">console.log(paths);</div>
<div class="line">//=&gt; [&#39;unicorn&#39;, &#39;rainbow&#39;]</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md5900"></a>
API</h1>
...
<h3><a class="anchor" id="autotoc_md5903"></a>
options</h3>
...
<h4><a class="anchor" id="autotoc_md5904"></a>
expandDirectories</h4>
<p >Type: <code>boolean | string[] | object</code>\ Default: <code>true</code></p>
...
<div class="fragment"><div class="line">import {globby} from &#39;globby&#39;;</div>
<div class="line"> </div>
<div class="line">(async () =&gt; {</div>
<div class="line">    const paths = await globby(&#39;images&#39;, {</div>
<div class="line">        expandDirectories: {</div>
<div class="line">            files: [&#39;cat&#39;, &#39;unicorn&#39;, &#39;*.jpg&#39;],</div>
<div class="line">            extensions: [&#39;png&#39;]</div>
<div class="line">        }</div>
<div class="line">    });</div>
<div class="line"> </div>
<div class="line">    console.log(paths);</div>
<div class="line">    //=&gt; [&#39;cat.png&#39;, &#39;unicorn.png&#39;, &#39;cow.jpg&#39;, &#39;rainbow.jpg&#39;]</div>
<div class="line">})();</div>
</div><!-- fragment --><p >Note that if you set this option to <code>false</code>, you won't get back matched directories unless you set <code>onlyFiles: false</code>.</p>
<h4><a class="anchor" id="autotoc_md5905"></a>
gitignore</h4>
...
<h2><a class="anchor" id="autotoc_md5906"></a>
globbySync(patterns, options?)</h2>
<p >Returns <code>string[]</code> of matching paths.</p>
<h2><a class="anchor" id="autotoc_md5907"></a>
globbyStream(patterns, options?)</h2>
...
<div class="fragment"><div class="line">import {globbyStream} from &#39;globby&#39;;</div>
<div class="line"> </div>
<div class="line">(async () =&gt; {</div>
<div class="line">    for await (const path of globbyStream(&#39;*.tmp&#39;)) {</div>
<div class="line">        console.log(path);</div>
<div class="line">    }</div>
<div class="line">})();</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md5908"></a>
generateGlobTasks(patterns, options?)</h2>
...
<h2><a class="anchor" id="autotoc_md5909"></a>
isDynamicPattern(patterns, options?)</h2>
...
<h2><a class="anchor" id="autotoc_md5910"></a>
isGitIgnored(options?)</h2>
<p >Returns a <code>Promise&lt;(path: URL | string) =&gt; boolean&gt;</code> indicating whether a given path is ignored via a <code>.gitignore</code> file.</p>
<p >Takes <code>cwd?: URL | string</code> and <code>ignore?: string[]</code> as options. <code>.gitignore</code> files matched by the ignore config are not used for the resulting filter function.</p>
<div class="fragment"><div class="line">import {isGitIgnored} from &#39;globby&#39;;</div>
<div class="line"> </div>
<div class="line">const isIgnored = await isGitIgnored();</div>
<div class="line"> </div>
<div class="line">console.log(isIgnored(&#39;some/file&#39;));</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md5911"></a>
isGitIgnoredSync(options?)</h2>
<p >Returns a <code>(path: URL | string) =&gt; boolean</code> indicating whether a given path is ignored via a <code>.gitignore</code> file.</p>
<p >Takes the same options as <code>isGitIgnored</code>.</p>
<h1><a class="anchor" id="autotoc_md5912"></a>
...
<h1><a class="anchor" id="autotoc_md5913"></a>
globby for enterprise</h1>
...
<h1><a class="anchor" id="autotoc_md5914"></a>
Related</h1>
<ul>
