...
<title>end to end lab: css &lt;a href=&quot;https://travis-ci.org/reworkcss/css&quot; &gt;&lt;img src=&quot;https://travis-ci.org/reworkcss/css.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<div><div class="header">
  <div class="headertitle"><div class="title">css <a href="https://travis-ci.org/reworkcss/css"><img src="https://travis-ci.org/reworkcss/css.svg?branch=master" alt="Build Status" style="pointer-events: none;" class="inline"/></a> </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p >CSS parser / stringifier.</p>
<h1><a class="anchor" id="autotoc_md4187"></a>
Installation</h1>
<pre class="fragment">$ npm install css
</pre> <h1><a class="anchor" id="autotoc_md4188"></a>
Usage</h1>
<div class="fragment"><div class="line">var css = require(&#39;css&#39;);</div>
<div class="line">var obj = css.parse(&#39;body { font-size: 12px; }&#39;, options);</div>
<div class="line">css.stringify(obj, options);</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md4189"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md4190"></a>
css.parse(code, [options])</h2>
...
css.stringify(object, [options])</h2>
...
<li>sourcemap: return a sourcemap along with the CSS output. Using the <code>source</code> option of <code>css.parse</code> is strongly recommended when creating a source map. Specify &lsquo;sourcemap: 'generator&rsquo;` to return the SourceMapGenerator object instead of serializing the source map.</li>
...
<h2><a class="anchor" id="autotoc_md4192"></a>
Example</h2>
<div class="fragment"><div class="line">var ast = css.parse(&#39;body { font-size: 12px; }&#39;, { source: &#39;source.css&#39; });</div>
<div class="line"> </div>
<div class="line">var css = css.stringify(ast);</div>
<div class="line"> </div>
<div class="line">var result = css.stringify(ast, { sourcemap: true });</div>
<div class="line">result.code // string with CSS</div>
<div class="line">result.map // source map object</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md4193"></a>
Errors</h2>
...
<p >When parsing with the <code>silent</code> option, errors are listed in the <code>parsingErrors</code> property of the `stylesheet` node instead of being thrown.</p>
<p >If you create any errors in plugins such as in <a href="https://github.com/reworkcss/rework">rework</a>, you <b>must</b> set the same properties for consistency.</p>
...
<h3><a class="anchor" id="autotoc_md4200"></a>
stylesheet</h3>
<p >The root node returned by <code>css.parse</code>.</p>
<ul>
<li>stylesheet: <code>Object</code>:<ul>
...
<h3><a class="anchor" id="autotoc_md4201"></a>
rule</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md4202"></a>
declaration</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md4203"></a>
comment</h3>
...
<h3><a class="anchor" id="autotoc_md4206"></a>
document</h3>
...
<h3><a class="anchor" id="autotoc_md4211"></a>
keyframe</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md4215"></a>
supports</h3>
...
Example</h2>
<p >CSS:</p>
<div class="fragment"><div class="line">body {</div>
<div class="line">  background: #eee;</div>
<div class="line">  color: #888;</div>
<div class="line">}</div>
</div><!-- fragment --><p >Parse tree:</p>
<div class="fragment"><div class="line">{</div>
<div class="line">  &quot;type&quot;: &quot;stylesheet&quot;,</div>
<div class="line">  &quot;stylesheet&quot;: {</div>
<div class="line">    &quot;rules&quot;: [</div>
<div class="line">      {</div>
<div class="line">        &quot;type&quot;: &quot;rule&quot;,</div>
<div class="line">        &quot;selectors&quot;: [</div>
<div class="line">          &quot;body&quot;</div>
<div class="line">        ],</div>
<div class="line">        &quot;declarations&quot;: [</div>
<div class="line">          {</div>
<div class="line">            &quot;type&quot;: &quot;declaration&quot;,</div>
<div class="line">            &quot;property&quot;: &quot;background&quot;,</div>
<div class="line">            &quot;value&quot;: &quot;#eee&quot;,</div>
...
<div class="line">                &quot;line&quot;: 2,</div>
<div class="line">                &quot;column&quot;: 19</div>
<div class="line">              }</div>
<div class="line">            }</div>
<div class="line">          },</div>
<div class="line">          {</div>
<div class="line">            &quot;type&quot;: &quot;declaration&quot;,</div>
<div class="line">            &quot;property&quot;: &quot;color&quot;,</div>
<div class="line">            &quot;value&quot;: &quot;#888&quot;,</div>
<div class="line">            &quot;position&quot;: {</div>
<div class="line">              &quot;start&quot;: {</div>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md4217"></a>
License</h1>
<p >MIT </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
