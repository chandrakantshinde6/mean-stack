...
<title>end to end lab: pify &lt;a href=&quot;https://travis-ci.org/sindresorhus/pify&quot; &gt;&lt;img src=&quot;https://travis-ci.org/sindresorhus/pify.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<h1><a class="anchor" id="autotoc_md10225"></a>
Install</h1>
<div class="fragment"><div class="line">$ npm install --save pify</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10226"></a>
Usage</h1>
...
<div class="line">});</div>
<div class="line"> </div>
<div class="line">// or promisify all methods in a module</div>
<div class="line"> </div>
<div class="line">pify(fs).readFile(&#39;package.json&#39;, &#39;utf8&#39;).then(data =&gt; {</div>
<div class="line">    console.log(JSON.parse(data).name);</div>
<div class="line">    //=&gt; &#39;pify&#39;</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10227"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md10228"></a>
pify(input, [promiseModule], [options])</h2>
<p >Returns a promise wrapped version of the supplied function or module.</p>
<h3><a class="anchor" id="autotoc_md10229"></a>
input</h3>
<p >Type: <code>function</code>, <code>object</code></p>
<p >Callback-style function or module whose methods you want to promisify.</p>
<h3><a class="anchor" id="autotoc_md10230"></a>
promiseModule</h3>
...
<h3><a class="anchor" id="autotoc_md10231"></a>
options</h3>
<h4><a class="anchor" id="autotoc_md10232"></a>
multiArgs</h4>
...
<div class="line">});</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md10233"></a>
include</h4>
...
<h4><a class="anchor" id="autotoc_md10234"></a>
exclude</h4>
...
<h4><a class="anchor" id="autotoc_md10235"></a>
excludeMain</h4>
<p >Type: <code>boolean</code> <br  />
 Default: <code>false</code></p>
...
<div class="line">        callback(data, null);</div>
<div class="line">    });</div>
<div class="line">};</div>
<div class="line"> </div>
...
<div class="line">    });</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10236"></a>
License</h1>
